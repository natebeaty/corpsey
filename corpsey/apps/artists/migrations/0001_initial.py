...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('artists_artist', (
            ...
            ('first_name', self.gf('django.db.models.fields.CharField')(max_length=250, blank=True)),
            ('last_name', self.gf('django.db.models.fields.CharField')(max_length=250, blank=True)),
