...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Comic.portal_to'
        db.add_column('comics_comic', 'portal_to',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='portal', null=True, to=orm['comics.Comic']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Comic.portal_to'
        db.delete_column('comics_comic', 'portal_to_id')
