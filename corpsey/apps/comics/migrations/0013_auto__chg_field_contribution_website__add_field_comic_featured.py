...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Contribution.website'
        db.alter_column('comics_contribution', 'website', self.gf('django.db.models.fields.URLField')(max_length=250))
        # Adding field 'Comic.featured'
        db.add_column('comics_comic', 'featured',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Contribution.website'
        db.alter_column('comics_contribution', 'website', self.gf('django.db.models.fields.CharField')(max_length=250))
        # Deleting field 'Comic.featured'
        db.delete_column('comics_comic', 'featured')
    ...
    models = {
        ...
        'comics.comic': {
            ...
            'artist': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'comics'", 'null': 'True', 'to': "orm['artists.Artist']"}),
        ...
        'comics.contribution': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'deadline': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
            'email': ('django.db.models.fields.CharField', [], {'max_length': '250', 'blank': 'True'}),
            'has_panels': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '250', 'blank': 'True'}),
            'notes': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'panel1': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'blank': 'True'}),
            ...
            'website': ('django.db.models.fields.URLField', [], {'max_length': '250', 'blank': 'True'})
        },
        'comics.rule': {
