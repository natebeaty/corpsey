...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contribution.has_panels'
        db.add_column('comics_contribution', 'has_panels',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contribution.has_panels'
        db.delete_column('comics_contribution', 'has_panels')
