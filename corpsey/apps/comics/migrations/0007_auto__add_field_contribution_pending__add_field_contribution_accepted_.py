...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contribution.pending'
        db.add_column('comics_contribution', 'pending',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Contribution.accepted'
        db.add_column('comics_contribution', 'accepted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Contribution.notes'
        db.add_column('comics_contribution', 'notes',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contribution.pending'
        db.delete_column('comics_contribution', 'pending')

        # Deleting field 'Contribution.accepted'
        db.delete_column('comics_contribution', 'accepted')

        # Deleting field 'Contribution.notes'
        db.delete_column('comics_contribution', 'notes')
