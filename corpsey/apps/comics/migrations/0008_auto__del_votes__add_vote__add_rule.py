...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('comics_vote', (
            ...
            ('rule_broke', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='rules_broke', null=True, to=orm['comics.Rule'])),
        ))
        db.send_create_signal('comics', ['Vote'])

        # Adding model 'Rule'
        db.create_table('comics_rule', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('text', self.gf('django.db.models.fields.CharField')(max_length=250, blank=True)),
        ))
        db.send_create_signal('comics', ['Rule'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'Vote'
        db.delete_table('comics_vote')

        # Deleting model 'Rule'
        db.delete_table('comics_rule')
    ...
    models = {
        ...
        'comics.vote': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'rule_broke': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'rules_broke'", 'to': "orm['comics.Rule']"}),
